function PlayerDiceTotal()
{
   var _loc1_ = 0;
   _loc1_ += Player.Dice;
   _loc1_ += Player.Spider.Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket01.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket01.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket02.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket02.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket03.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket03.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket04.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket04.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket05.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket05.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket06.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket06.Card.CardID).Dice;
   _loc1_ += !DeckPlayerInHandUI.Socket07.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket07.Card.CardID).Dice;
   return _loc1_;
}
function PlayerDefenceTotal()
{
   var _loc1_ = 0;
   _loc1_ += Player.Defence;
   _loc1_ += Player.Spider.Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket01.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket01.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket02.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket02.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket03.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket03.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket04.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket04.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket05.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket05.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket06.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket06.Card.CardID).Defence;
   _loc1_ += !DeckPlayerInHandUI.Socket07.Card.IsActive ? 0 : LookUpCard(DeckPlayerInHandUI.Socket07.Card.CardID).Defence;
   return _loc1_;
}
...
Player.Spider.Name = root.sprName;
Player.Spider.Dice = BattleSystem._parent.FromEnginePlayer.spider.dice;
Player.Spider.Defence = BattleSystem._parent.FromEnginePlayer.spider.defense;
Player.Spider.LifePoint = BattleSystem._parent.FromEnginePlayer.spider.action;
